...
public class GoalController {
	...
	public String getGoals(Model model) {
		List<Goal> goalsList = goalService.findAllGoals();
	...
	public String getGoalReports(Model model) {
		List<GoalReport> goalReportsList = goalService.findAllGoalReports();
		model.addAttribute("goalReports", goalReportsList);
